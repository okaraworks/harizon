...
<div id="wrapper">
    	...
    	<div id="page-wrapper">
    		<div class="col-lg-12">
            <button class="btn btn-sm btn-primary" onclick="window.location='addmynextofkin'">Add</button>
                ...
                foreach ($member as $key => $value) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="deletemynext?id=<?php echo $value['user_id']?>"><i class="fa fa-trash-o"></i></a>
