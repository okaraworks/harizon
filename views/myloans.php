            ...
            <button class="btn btn-sm btn-info" onClick="window.print()">Print</button>
                ...
                <div class="panel panel-primary">
                  <div class="panel-heading">
                    <h3 class="panel-title">My Loan Records</h3>
                  </div>
    		...
    		<table class="table table-bordered table-hover table-striped tablesorter" id="dataTable" width="100%" cellspacing="0">
                ...
                foreach ($loan as $key => $value) {
                    if($value['status'] ==0){
                        ...
                        $btn= "<button data-toggle='modal' data-target='#myModal' value='".$value['id']."' onClick='repayLoan(this.value)' class='btn btn-sm btn-success'>Repay</button>";
                    }
                     ?>
                    <tr>
