...
<div id="wrapper">
        ...
        <div class="panel panel-primary" >
              <div class="panel-heading">
                <h3 class="panel-title">Children Registration</h3>
              </div>
            
              <div class="panel-body">
              <input type="text" name="nid" onChange="search(this.value)" name="search" placeholder="Enter Parent's Id Number"><button>Search</button>
                <div class="table-responsive" id="hapa">
                <?php echo Persons::regChildren();?>
                </div>
                </div>
              </div>
              </div>
...
<script>
    ...
    if (str == "") {
        ...
        xmlhttp.open("GET","register-children?q="+str,true);
        xmlhttp.send();
    }
}
</script>