...
<div id="wrapper">
    	...
    	<div id="page-wrapper">
            ...
            <?php Persons::registerMe()?> 
                ...
                <div class="form-group">
                    <input type="text" name="nid" value="<?php echo $value['username']?>" placeholder="National Id" class="form-control" required="" readonly >
                </div>
                ...
                <div class="form-group">
                    <input type="text" name="phone" value="<?php echo $value['phone']?>" placeholder="Mobile Number" class="form-control" required readonly>
                </div>

                <div class="form-group">
                    <input type="email" name="email" value="<?php echo $value['email']?>" placeholder="Email Address" class="form-control" readonly >
                </div>
                    <?php }?>
                <div class="form-group">
